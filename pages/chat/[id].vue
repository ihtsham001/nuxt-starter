<template>
  <div class="flex flex-col h-screen bg-gray-100 p-4 px-5">
    ...
    <div class="flex justify-end items-center gap-3 hover:text-primary-yellow">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
      ...
      <span class="text-sm"> Chat with Live Tax Pro?</span>
      <div
        class="flex flex-col md:flex-row lg:flex-row xl:flex-row gap-3 justify-center"
      >
        <button
    ...
    >
      <div
        class="w-70 flex flex-row gap-2 pr-2 items-center md:flex-row lg:flex-row xl:flex-row text-center p-2 rounded-md w-full focus:outline-none border-2 hover:border-primary-yellow border-border-gray text-primary-yellow"
      >
        <img
        ...
        <input
          type="text"
          class="rounded-md w-full focus:outline-none border-0 bg-transparent placeholder:text-border-gray text-black"
